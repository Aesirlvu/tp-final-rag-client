                ...
                <div className="px-4 py-3 flex items-center gap-4 border-t border-border">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className={`p-2 rounded-md transition ${settings.showDocuments
                        ...
                        <button
                            ...
                            className={`p-2 rounded-md transition ${settings.showMetadata
                                ? "bg-primary text-primary-foreground"
                                : "bg-muted text-muted-foreground hover:bg-accent hover:text-accent-foreground"
                                }`}
                        ...
                        <button
                            ...
                            className={`p-2 rounded-md transition ${settings.showLines
                                ? "bg-primary text-primary-foreground"
                                : "bg-muted text-muted-foreground hover:bg-accent hover:text-accent-foreground"
                                }`}
